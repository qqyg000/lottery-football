...
> 当前内置比赛数据快照更新至 2026-08-13，球队名映射更新至 2026-08-29。项目仅用于数据分析、算法学习和开发验证，不构成投注建议。
...
| 文件 | 行数 | 日期范围 |
|---|---:|---|
| `historical_matches.csv` | 237,035 | 2014-10-22 至 2026-08-25 |
| `historical_odds_data.csv` | 29,251 | 2014-10-22 至 2026-08-11 |
| `team_name_mappings.csv` | 24,597 | 2014-06-24 至 2026-08-29 |
