...
class ClubTeamNameTranslatorTest {
    ...
    void shouldApplyRequestedCanonicalClubNames() throws IOException {
        ...
        Map<String, String> expectedMappings = Map.ofEntries(
                ...
                Map.entry("Bad Schallerbach", "Bad Schallerbach"),
                Map.entry("Schallerbach", "Bad Schallerbach"),
                Map.entry("Kauno Zalgiris", "Kauno Zalgiris"),
                Map.entry("FK Kauno Zalgiris", "Kauno Zalgiris"),
