...
const USER_REQUESTED_TEAM_ALIASES = [
  ...
  ['维尔茨堡', 'Würzburger Kickers', '2026-08-29'],
  ['奥厄', 'Aue', '2026-08-29'],
  ['奥厄', 'Erzgebirge Aue', '2026-08-29'],
  ['Krieschow', 'VfB Krieschow', '2026-08-29'],
  ['迪拜国青', '迪拜国民青年', '2026-08-29'],
  ['Phönix Lübeck', '1. FC Phönix Lübeck', '2026-08-29'],
  ['特里尔', 'Eintracht Trier', '2026-08-29'],
  ['Altglienicke', 'VSG Altglienicke', '2026-08-29'],
  ['Schott', 'TSV Schott Mainz', '2026-08-29'],
  ['不伦瑞克', 'Eintracht Braunschweig', '2026-08-29'],
  ['贝内文托', 'Benevento Calcio', '2026-08-29'],
  ['LSK Hansa', 'FC Hansa Lüneburg', '2026-08-29'],
  ['冈山绿雉', 'Fagiano Okayama FC', '2026-08-29'],
  ['冈山绿雉', 'Fagiano', '2026-08-29'],
  ['科特布斯', 'Energie Cottbus', '2026-08-29'],
  ['Schwaz', 'SC Schwaz', '2026-08-29'],
  ['萨布吕肯', 'Saarbrücken', '2026-08-29'],
  ['萨布吕肯', '1. FC Saarbrücken', '2026-08-29'],
  ['哈雷', 'Hallescher FC', '2026-08-29'],
  ['黑森卡塞尔', 'Hessen Kassel', '2026-08-29'],
  ['居特斯洛', 'FC Gütersloh', '2026-08-29'],
  ['拜仁', '拜仁慕尼黑', '2026-08-28'],
  ['韦恩', 'Wehen Wiesbaden', '2026-08-28'],
  ['韦恩', 'SV Wehen', '2026-08-28'],
  ['奥踢球者', 'Kickers Offenbach', '2026-08-28'],
  ['Hollenbach', 'FSV Hollenbach', '2026-08-28'],
  ['Balingen', 'TSG Balingen', '2026-08-28'],
  ['马洛卡', 'Real Mallorca', '2026-08-28'],
  ['埃沃斯堡', '埃尔沃斯堡', '2026-08-28'],
  ['埃森', 'RW Essen', '2026-08-28'],
  ['门兴', '门兴格拉德巴赫', '2026-08-28'],
  ['罗斯托克', 'Hansa Rostock', '2026-08-28'],
  ['乌珀塔尔', 'Wuppertaler SV', '2026-08-28'],
  ['乌珀塔尔', 'Wuppertal', '2026-08-28'],
  ['德累斯顿', 'Dynamo Dresden', '2026-08-28'],
  ['阿劳', 'Aarau', '2026-08-28'],
  ['温特图尔', 'Winterthur', '2026-08-28'],
  ['温特图尔', 'Winterthour', '2026-08-28'],
  ['耶拿', 'Jena', '2026-08-28'],
  ['耶拿', 'Carl Zeiss Jena', '2026-08-28'],
  ['开姆尼茨', 'Chemnitzer FC', '2026-08-28'],
  ['开姆尼茨', 'Chemnitz', '2026-08-28'],
  ['奥普迪克', 'Rathenow', '2026-08-28'],
  ['奥普迪克', 'Optik Rathenow', '2026-08-28'],
  ['奥普迪克', 'FCV Optik Rathenow', '2026-08-28'],
  ['FSV法兰', 'FSV Frankfurt', '2026-08-28'],
  ['Gießen', 'FC Gießen', '2026-08-28'],
  ['桑德豪森', 'Sandhausen', '2026-08-28'],
  ['Eisbachtal', 'Eisbachtaler Sportfreunde', '2026-08-28'],
  ['Eisbachtal', 'Spfr Eisbachtal', '2026-08-28'],
  ['奥斯纳', 'VfL Osnabruck', '2026-08-28'],
  ['马格德堡', 'Magdeburg', '2026-08-28'],
  ['马格德堡', 'Magdebourg', '2026-08-28'],
  ['普雷斯顿', 'Preston North End', '2026-08-28'],
  ['普利茅斯', 'Plymouth Argyle', '2026-08-28'],
  ...
  ['Bad Schallerbach', 'Bad Schallerbach', '2026-08-25'],
  ['Bad Schallerbach', 'Schallerbach', '2026-08-25'],
  ['Kauno Zalgiris', 'Kauno Zalgiris', '2026-08-25'],
  ['Kauno Zalgiris', 'FK Kauno Zalgiris', '2026-08-25'],
